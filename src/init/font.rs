pub fn draw_char(c: u8, x: usize, y: usize, fb: *mut u64, pitch: usize, fg: u64, font: &[u8]) {
...
fn draw_char_psf(font: &PsfFont, ch: u8, x: usize, y: usize, color: u32, framebuffer: *mut u64, _pitch: usize, _bpp: usize) {
            ...
            for col in 0..font.width {
                if (row_byte >> (7 - col)) & 1 != 0 {
                    unsafe { 
                        ...
                        framebuffer.add(offset + 1).write_volatile(color as u64);
                    }
                }
            }
        }
